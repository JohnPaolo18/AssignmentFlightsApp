...
namespace AssignmentFlightsApp.Models
{
    internal class ReservationManager
    {
        ...
        public List<Reservation> FindReservations(string reservationCode, string airline, string name)
        {
            ...
            {
                if (reservation.FlightCode.Contains(reservationCode) && reservation.Airline.Contains(airline) && reservation.Name.Contains(name))
                {
                    found.Add(reservation);
                }
                else if (reservation.FlightCode.Contains(reservationCode))
                {
                    found.Add(reservation);
                }
                // TODO
